 ...
 * The original variable name (SVr) is preserved for compatibility.
...
var SVr = T((SPe) => {
  "use strict";
  Object.defineProperty(SPe, "__esModule", { value: !0 });
  SPe.envDetector = void 0;
  var FTo = (Zt(), bt(cr)),
    UTo = ($1(), bt(Ih)),
    CVr = Ii(),
    yCt = class {
      ...
      detect(e) {
        let r = {},
          n = (0, CVr.getStringFromEnv)("OTEL_RESOURCE_ATTRIBUTES"),
          o = (0, CVr.getStringFromEnv)("OTEL_SERVICE_NAME");
        if (n)
          try {
            let s = this._parseResourceAttributes(n);
            Object.assign(r, s);
          } catch (s) {
            FTo.diag.debug(`EnvDetector failed: ${s.message}`);
          }
        return (o && (r[UTo.ATTR_SERVICE_NAME] = o), { attributes: r });
      }
