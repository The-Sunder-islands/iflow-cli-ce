 ...
 * The original variable name (xin) is preserved for compatibility.
...
var xin = T((Rje) => {
  ...
  var tYo = (Zt(), bt(cr)),
    ...
    q7t = class {
      ...
      detect(e) {
        let r = {},
          n = (0, win.getStringFromEnv)("OTEL_RESOURCE_ATTRIBUTES"),
          o = (0, win.getStringFromEnv)("OTEL_SERVICE_NAME");
        if (n)
          try {
            let s = this._parseResourceAttributes(n);
            Object.assign(r, s);
          } catch (s) {
            tYo.diag.debug(`EnvDetector failed: ${s.message}`);
          }
        return (o && (r[rYo.ATTR_SERVICE_NAME] = o), { attributes: r });
      }
