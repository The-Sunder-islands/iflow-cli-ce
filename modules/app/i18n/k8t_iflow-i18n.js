 ...
 * The original variable name (k8t) is preserved for compatibility.
...
function rG(t, e = {}) {
  ...
  let o = 0,
    s = { ambiguousAsWide: !r };
  for (let { segment: a } of Oco.segment(t)) {
...
var WSr,
  ...
  zSr = j(() => {
    s_();
    XP();
    ((WSr = Se(k8t(), 1)), (Oco = new Intl.Segmenter()), (Nco = /^\p{Default_Ignorable_Code_Point}$/u));
  });
function Lco() {
  let t = new Map();
  for (let [e, r] of Object.entries(Km)) {
    for (let [n, o] of Object.entries(r))
      ((Km[n] = { open: `\x1B[${o[0]}m`, close: `\x1B[${o[1]}m` }), (r[n] = Km[n]), t.set(o[0], o[1]));
    Object.defineProperty(Km, e, { value: r, enumerable: !1 });
  }
  return (
    Object.defineProperty(Km, "codes", { value: t, enumerable: !1 }),
    (Km.color.close = "\x1B[39m"),
    (Km.bgColor.close = "\x1B[49m"),
    (Km.color.ansi = YSr()),
    (Km.color.ansi256 = KSr()),
    (Km.color.ansi16m = JSr()),
    (Km.bgColor.ansi = YSr(10)),
    (Km.bgColor.ansi256 = KSr(10)),
    (Km.bgColor.ansi16m = JSr(10)),
    Object.defineProperties(Km, {
      rgbToAnsi256: {
        value(e, r, n) {
          return e === r && r === n
            ? e < 8
      ...
      hexToAnsi256: { value: (e) => Km.rgbToAnsi256(...Km.hexToRgb(e)), enumerable: !1 },
      ansi256ToAnsi: {
        value(e) {
          if (e < 8) return 30 + e;
      ...
      rgbToAnsi: { value: (e, r, n) => Km.ansi256ToAnsi(Km.rgbToAnsi256(e, r, n)), enumerable: !1 },
      hexToAnsi: { value: (e) => Km.ansi256ToAnsi(Km.hexToAnsi256(e)), enumerable: !1 },
    }),
    Km
  );
}
var YSr,
  ...
  ZSr = j(() => {
    ((YSr =
      ...
      (b6u = Object.keys(Km.modifier)),
      (Pco = Object.keys(Km.color)),
      (Bco = Object.keys(Km.bgColor)),
      (A6u = [...Pco, ...Bco]));
    ((Mco = Lco()), (XSr = Mco));
  });
function vhe(t, e, r) {
...
var Y7e,
  ...
  P8t = j(() => {
    ...
    ((Y7e = new Set(["\x1B", "\x9B"])),
      ...
      (nwr = "m"),
      (z7e = `${Uco}8;;`),
      (ewr = (t) => `${Y7e.values().next().value}${rwr}${t}${nwr}`),
      (twr = (t) => `${Y7e.values().next().value}${z7e}${t}${N8t}`),
      ($co = (t) => t.split(" ").map((e) => rG(e))),
      (O8t = (t, e, r) => {
        let n = [...e],
          o = !1,
          s = !1,
        ...
        for (let [u, c] of n.entries()) {
          ...
          if (
            ...
            Y7e.has(c) && ((o = !0), (s = n.slice(u + 1, u + 1 + z7e.length).join("") === z7e)),
            o)
          ) {
            s ? c === N8t && ((o = !1), (s = !1)) : c === nwr && (o = !1);
            continue;
          }
      ...
      (Qco = (t, e, r = {}) => {
        ...
        for (let [f, p] of t.split(" ").entries()) {
          ...
          if (
            ...
            (Math.floor((a[f] - 1) / e) < b && u.push(""), O8t(u, p, e));
            continue;
          }
...
`),
        ...
        for (let [f, p] of m.entries()) {
          if (((n += p), Y7e.has(p))) {
            let { groups: g } = new RegExp(`(?:\\${rwr}(?<code>\\d+)m|\\${z7e}(?<uri>.*)${N8t})`).exec(c.slice(d)) || {
              groups: {},
            };
            if (g.code !== void 0) {
