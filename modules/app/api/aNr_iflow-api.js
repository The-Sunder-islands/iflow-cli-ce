...
var uNr,
  cNr = j(() => {
    ...
    uNr = {
      ...
      about: {
        title: "About iFlow CLI Community Edition",
...
{{description}}`,
      ...
      authDialog: {
        ...
        termsOfService: "Terms of Services and Privacy Notice for iFlow CLI Community Edition",
...
{{error}}`,
        ...
        defaultBugDescription: "User reported a bug in iFlow CLI CE",
...
Error: {{error}}`,
      ...
      renderCommand: {
        description: "Switch web page renderer. Usage: /render lightpanda | /render happy-dom | /render browser39 | /render chromium | /render status",
        lightpanda: "Lightpanda (Zig headless, Linux default)",
        happydom: "HappyDOM (JS DOM, Windows default)",
        browser39: "browser39 (Rust headless, JS rendering)",
        chromium: "Chromium (Playwright, all platforms)",
        status: "Show current renderer status",
        switchingLightpanda: "Switched to Lightpanda renderer (default on Linux)",
        switchingHappyDom: "Switched to HappyDOM renderer (default on Windows)",
        switchingChromium: "Switched to Chromium renderer",
        checking: "Checking Chromium installation... (1/3)",
        downloading: "Downloading Chromium (~300MB)... (2/3) Please wait, messages cannot be sent during this time.",
        verifying: "Verifying Chromium installation... (3/3)",
        installDone: "Chromium installed! Switched to Chromium renderer.",
        installFailed: "Chromium installation failed, reverted to Lightpanda. Run 'npx playwright install chromium' in terminal, then restart iFlow.",
        statusLine: "Renderer: {{renderer}}",
        notAvailable: "SearchRenderer not available",
      },
      skillAdd: {
...
\u26A0\uFE0F  Please restart the CLI to use the new command.`,
      ...
      examplesDisplay: {
        ...
        welcome: "Welcome to iFlow CLI Community Edition! Check out these examples to get the most out of your experience:",
...
Error: {{error}}`,
      ...
      systemNotification: {
        appName: '"iFlow CLI CE" notification',
...
\u9519\u8BEF\uFF1A{{error}}`,
      ...
      renderCommand: {
        description: "\u5207\u6362\u7F51\u9875\u6E32\u67D3\u5668\u3002\u7528\u6CD5\uFF1A/render lightpanda | /render happy-dom | /render browser39 | /render chromium | /render status",
        lightpanda: "Lightpanda\uFF08Zig \u65E0\u5934\u6D4F\u89C8\u5668\uFF0CLinux \u9ED8\u8BA4\uFF09",
        happydom: "HappyDOM\uFF08JS DOM\u6A21\u62DF\uFF0CWindows \u9ED8\u8BA4\uFF09",
        browser39: "browser39\uFF08Rust \u65E0\u5934\u6D4F\u89C8\u5668\uFF0C\u652F\u6301 JS\u6E32\u67D3\uFF09",
        chromium: "Chromium\uFF08Playwright\uFF0C\u5168\u5E73\u53F0\uFF09",
        status: "\u67E5\u770B\u5F53\u524D\u6E32\u67D3\u5668\u72B6\u6001",
        switchingLightpanda: "\u5DF2\u5207\u6362\u5230 Lightpanda \u6E32\u67D3\u5668\uFF08\u9ED8\u8BA4\uFF09",
        switchingHappyDom: "\u5DF2\u5207\u6362\u5230 HappyDOM \u6E32\u67D3\u5668\uFF08Windows \u9ED8\u8BA4\uFF09",
        switchingChromium: "\u5DF2\u5207\u6362\u5230 Chromium \u6E32\u67D3\u5668",
        checking: "Chromium \u5B89\u88C5\u68C0\u6D4B\u4E2D... (1/3)",
        downloading: "Chromium \u4E0B\u8F7D\u4E2D\uFF08\u7EA6 300MB\uFF09... (2/3)\u8BF7\u7A0D\u5019\uFF0C\u6B64\u671F\u95F4\u65E0\u6CD5\u53D1\u9001\u6D88\u606F",
        verifying: "Chromium \u9A8C\u8BC1\u4E2D... (3/3)",
        installDone: "Chromium \u5B89\u88C5\u5B8C\u6210\uFF01\u5DF2\u5207\u6362\u5230 Chromium \u6E32\u67D3\u5668\u3002",
        installFailed: "Chromium \u5B89\u88C5\u5931\u8D25\uFF0C\u5DF2\u5207\u56DE Lightpanda\u3002\u8BF7\u5728\u7EC8\u7AEF\u4E2D\u6267\u884C\uFF1A\u201Cnpx playwright install chromium\u201D\u7136\u540E\u91CD\u542F iflow\u3002",
        statusLine: "\u5F53\u524D\u6E32\u67D3\u5668\uFF1A{{renderer}}",
        notAvailable: "SearchRenderer \u4E0D\u53EF\u7528",
      },
      skillAdd: {
