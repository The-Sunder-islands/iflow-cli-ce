 ...
 * The original variable name (g_i) is preserved for compatibility.
...
var g_i = T((_Jc, XPa) => {
  XPa.exports = {
    ...
    repository: { type: "git", url: "https://github.com/aws/aws-sdk-js-v3.git", directory: "clients/client-s3" },
  };
});