 ...
 * The original variable name (lLn) is preserved for compatibility.
...
var lLn = T((i8c, cLn) => {
  var BF = Ae("constants"),
    Djs = process.cwd,
    Ftt = null,
    Ijs = process.env.GRACEFUL_FS_PLATFORM || process.platform;
  process.cwd = function () {
    return (Ftt || (Ftt = Djs.call(process)), Ftt);
  };
  try {
    process.cwd();
  } catch {}
  typeof process.chdir == "function" &&
    ...
    (process.chdir = function (t) {
      ((Ftt = null), ter.call(process, t));
    }),
    Object.setPrototypeOf && Object.setPrototypeOf(process.chdir, ter));
  var ter;
  cLn.exports = Rjs;
  function Rjs(t) {
    (BF.hasOwnProperty("O_SYMLINK") && process.version.match(/^v0\.6\.[0-2]|^v0\.5\./) && e(t),
      t.lutimes || r(t),
      (t.chown = s(t.chown)),
      (t.fchown = s(t.fchown)),
      (t.lchown = s(t.lchown)),
    ...
    function e(d) {
      ((d.lchmod = function (f, p, h) {
        d.open(f, BF.O_WRONLY | BF.O_SYMLINK, p, function (g, b) {
          if (g) {
            h && h(g);
            return;
          }
        ...
        (d.lchmodSync = function (f, p) {
          var h = d.openSync(f, BF.O_WRONLY | BF.O_SYMLINK, p),
            g = !0,
            b;
          try {
    ...
    function r(d) {
      BF.hasOwnProperty("O_SYMLINK") && d.futimes
        ? ((d.lutimes = function (f, p, h, g) {
            d.open(f, BF.O_SYMLINK, function (b, A) {
              if (b) {
                g && g(b);
                return;
              }
          ...
          (d.lutimesSync = function (f, p, h) {
            var g = d.openSync(f, BF.O_SYMLINK),
              b,
              A = !0;
            try {
