...
var dhn = T((dg) => {
  ...
  dg.CodeGen = dg.Name = dg.nil = dg.stringify = dg.str = dg._ = dg.KeywordCxt = void 0;
  var rms = s8e();
  Object.defineProperty(dg, "KeywordCxt", {
    enumerable: !0,
    get: function () {
      return rms.KeywordCxt;
    },
  });
  var Uoe = Ha();
  Object.defineProperty(dg, "_", {
    enumerable: !0,
    get: function () {
      return Uoe._;
    },
  });
  Object.defineProperty(dg, "str", {
    enumerable: !0,
    get: function () {
      return Uoe.str;
    },
  });
  Object.defineProperty(dg, "stringify", {
    enumerable: !0,
    get: function () {
      return Uoe.stringify;
    },
  });
  Object.defineProperty(dg, "nil", {
    enumerable: !0,
    get: function () {
      return Uoe.nil;
    },
  });
  Object.defineProperty(dg, "Name", {
    enumerable: !0,
    get: function () {
      return Uoe.Name;
    },
  });
  Object.defineProperty(dg, "CodeGen", {
    enumerable: !0,
    get: function () {
      return Uoe.CodeGen;
    },
  ...
  var nms = Bze(),
    ...
    ohn = Hpn(),
    sms = ihn(),
    lhn = (t, e) => new RegExp(t, e);
  lhn.code = "new RegExp";
  var ams = ["removeAdditional", "useDefaults", "coerceTypes"],
    ums = new Set([
      "validate",
      "serialize",
      "parse",
  ...
  function mms(t) {
    ...
    let O = t.strict,
      ...
      B = (n = (r = t.code) === null || r === void 0 ? void 0 : r.regExp) !== null && n !== void 0 ? n : lhn,
      L = (o = t.uriResolver) !== null && o !== void 0 ? o : sms.default;
    return {
      ...
      loopRequired: (b = t.loopRequired) !== null && b !== void 0 ? b : shn,
      loopEnum: (A = t.loopEnum) !== null && A !== void 0 ? A : shn,
  ...
  var m8e = class {
    constructor(e = {}) {
      ...
      ((this.scope = new oms.ValueScope({ scope: {}, prefixes: ums, es5: r, lines: n })),
        (this.logger = bms(e.logger)));
      let o = e.validateFormats;
      ((e.validateFormats = !1),
        (this.RULES = (0, ims.getRules)()),
        ahn.call(this, cms, e, "NOT SUPPORTED"),
        ahn.call(this, lms, e, "DEPRECATED", "warn"),
        (this._metaOpts = hms.call(this)),
        e.formats && fms.call(this),
        this._addVocabularies(),
        this._addDefaultMetaSchema(),
        e.keywords && pms.call(this, e.keywords),
    ...
    _addDefaultMetaSchema() {
      let { $data: e, meta: r, schemaId: n } = this.opts,
        o = ohn;
      (n === "id" && ((o = { ...ohn }), (o.id = o.$id), delete o.$id), r && e && this.addMetaSchema(o, o[n], !1));
    }
    defaultMeta() {
    ...
    compileAsync(e, r) {
      ...
      async function a(d) {
        try {
          ...
          if (!(f instanceof chn.default)) throw f;
    ...
    getSchema(e) {
      let r;
      for (; typeof (r = uhn.call(this, e)) == "string"; ) e = r;
      if (r === void 0) {
        let { schemaId: n } = this.opts,
          o = new c8e.SchemaEnv({ schema: {}, schemaId: n });
        if (((r = c8e.resolveSchema.call(this, o, e)), !r)) return;
        this.refs[e] = r;
      }
    ...
    removeSchema(e) {
      ...
      switch (typeof e) {
        ...
        case "object": {
          ...
          return (n && ((n = (0, l8e.normalizeId)(n)), delete this.schemas[n], delete this.refs[n]), this);
        }
        default:
    ...
    addKeyword(e, r) {
      ...
      if ((yms.call(this, n, r), !r)) return ((0, mFt.eachItem)(n, (s) => lFt.call(this, s)), this);
      Ems.call(this, r);
      let o = { ...r, type: (0, Gze.getJSONTypes)(r.type), schemaType: (0, Gze.getJSONTypes)(r.schemaType) };
      return (
        (0, mFt.eachItem)(
          n,
          o.type.length === 0 ? (s) => lFt.call(this, s, o) : (s) => o.type.forEach((a) => lFt.call(this, s, o, a)),
        ),
        this
      );
    }
    ...
    _addSchema(e, r, n, o = this.opts.validateSchema, s = this.opts.addUsedSchema) {
      ...
      n = (0, l8e.normalizeId)(a || n);
      let m = l8e.getSchemaRefs.call(this, e, n);
      return (
        (c = new c8e.SchemaEnv({ schema: e, schemaId: u, meta: r, baseId: n, localRefs: m })),
    ...
    _compileSchemaEnv(e) {
      if ((e.meta ? this._compileMetaSchema(e) : c8e.compileSchema.call(this, e), !e.validate))
    ...
    _compileMetaSchema(e) {
      ...
      try {
        c8e.compileSchema.call(this, e);
      } finally {
        this.opts = r;
      }
    }
  };
  m8e.ValidationError = nms.default;
  m8e.MissingRefError = chn.default;
  dg.default = m8e;
  function ahn(t, e, r, n = "error") {
    for (let o in t) {
      let s = o;
  ...
  function uhn(t) {
    return ((t = (0, l8e.normalizeId)(t)), this.schemas[t] || this.refs[t]);
  }
  function dms() {
  ...
  function hms() {
    let t = { ...this.opts };
    for (let e of ams) delete t[e];
    return t;
  }
  var gms = { log() {}, warn() {}, error() {} };
  function bms(t) {
    if (t === !1) return gms;
  ...
  var Ams = /^[a-z_$][a-z0-9_$:-]*$/i;
  function yms(t, e) {
    let { RULES: r } = this;
    if (
      ((0, mFt.eachItem)(t, (n) => {
        if (r.keywords[n]) throw new Error(`Keyword ${n} is already defined`);
        if (!Ams.test(n)) throw new Error(`Keyword ${n} has invalid name`);
      }),
  ...
  function lFt(t, e, r) {
    ...
    let u = {
      keyword: t,
      definition: { ...e, type: (0, Gze.getJSONTypes)(e.type), schemaType: (0, Gze.getJSONTypes)(e.schemaType) },
    };
    (e.before ? _ms.call(this, a, u, e.before) : a.rules.push(u),
      (s.all[t] = u),
  ...
  function Ems(t) {
    let { metaSchema: e } = t;
    e !== void 0 && (t.$data && this.opts.$data && (e = mhn(e)), (t.validateSchema = this.compile(e, !0)));
  }
  var vms = { $ref: "https://raw.githubusercontent.com/ajv-validator/ajv/master/lib/refs/data.json#" };
  function mhn(t) {
    return { anyOf: [t, vms] };
  }
});