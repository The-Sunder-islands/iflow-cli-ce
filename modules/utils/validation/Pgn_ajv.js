 ...
 * The original variable name (Pgn) is preserved for compatibility.
...
var Pgn = T((pg) => {
  ...
  pg.CodeGen = pg.Name = pg.nil = pg.stringify = pg.str = pg._ = pg.KeywordCxt = void 0;
  var chs = P8e();
  Object.defineProperty(pg, "KeywordCxt", {
    enumerable: !0,
    get: function () {
      return chs.KeywordCxt;
    },
  });
  var Zoe = _a();
  Object.defineProperty(pg, "_", {
    enumerable: !0,
    get: function () {
      return Zoe._;
    },
  });
  Object.defineProperty(pg, "str", {
    enumerable: !0,
    get: function () {
      return Zoe.str;
    },
  });
  Object.defineProperty(pg, "stringify", {
    enumerable: !0,
    get: function () {
      return Zoe.stringify;
    },
  });
  Object.defineProperty(pg, "nil", {
    enumerable: !0,
    get: function () {
      return Zoe.nil;
    },
  });
  Object.defineProperty(pg, "Name", {
    enumerable: !0,
    get: function () {
      return Zoe.Name;
    },
  });
  Object.defineProperty(pg, "CodeGen", {
    enumerable: !0,
    get: function () {
      return Zoe.CodeGen;
    },
  ...
  var lhs = bYe(),
    ...
    Tgn = Sgn(),
    fhs = xgn(),
    Ogn = (t, e) => new RegExp(t, e);
  Ogn.code = "new RegExp";
  var phs = ["removeAdditional", "useDefaults", "coerceTypes"],
    hhs = new Set([
      "validate",
      "serialize",
      "parse",
  ...
  function Ahs(t) {
    ...
    let O = t.strict,
      ...
      B = (n = (r = t.code) === null || r === void 0 ? void 0 : r.regExp) !== null && n !== void 0 ? n : Ogn,
      L = (o = t.uriResolver) !== null && o !== void 0 ? o : fhs.default;
    return {
      ...
      loopRequired: (b = t.loopRequired) !== null && b !== void 0 ? b : Dgn,
      loopEnum: (A = t.loopEnum) !== null && A !== void 0 ? A : Dgn,
  ...
  var F8e = class {
    constructor(e = {}) {
      ...
      ((this.scope = new dhs.ValueScope({ scope: {}, prefixes: hhs, es5: r, lines: n })),
        (this.logger = Shs(e.logger)));
      let o = e.validateFormats;
      ((e.validateFormats = !1),
        (this.RULES = (0, mhs.getRules)()),
        Ign.call(this, ghs, e, "NOT SUPPORTED"),
        Ign.call(this, bhs, e, "DEPRECATED", "warn"),
        (this._metaOpts = vhs.call(this)),
        e.formats && _hs.call(this),
        this._addVocabularies(),
        this._addDefaultMetaSchema(),
        e.keywords && Ehs.call(this, e.keywords),
    ...
    _addDefaultMetaSchema() {
      let { $data: e, meta: r, schemaId: n } = this.opts,
        o = Tgn;
      (n === "id" && ((o = { ...Tgn }), (o.id = o.$id), delete o.$id), r && e && this.addMetaSchema(o, o[n], !1));
    }
    defaultMeta() {
    ...
    compileAsync(e, r) {
      ...
      async function a(d) {
        try {
          ...
          if (!(f instanceof kgn.default)) throw f;
    ...
    getSchema(e) {
      let r;
      for (; typeof (r = Rgn.call(this, e)) == "string"; ) e = r;
      if (r === void 0) {
        let { schemaId: n } = this.opts,
          o = new L8e.SchemaEnv({ schema: {}, schemaId: n });
        if (((r = L8e.resolveSchema.call(this, o, e)), !r)) return;
        this.refs[e] = r;
      }
    ...
    removeSchema(e) {
      ...
      switch (typeof e) {
        ...
        case "object": {
          ...
          return (n && ((n = (0, M8e.normalizeId)(n)), delete this.schemas[n], delete this.refs[n]), this);
        }
        default:
    ...
    addKeyword(e, r) {
      ...
      if ((xhs.call(this, n, r), !r)) return ((0, zUt.eachItem)(n, (s) => WUt.call(this, s)), this);
      Dhs.call(this, r);
      let o = { ...r, type: (0, _Ye.getJSONTypes)(r.type), schemaType: (0, _Ye.getJSONTypes)(r.schemaType) };
      return (
        (0, zUt.eachItem)(
          n,
          o.type.length === 0 ? (s) => WUt.call(this, s, o) : (s) => o.type.forEach((a) => WUt.call(this, s, o, a)),
        ),
        this
      );
    }
    ...
    _addSchema(e, r, n, o = this.opts.validateSchema, s = this.opts.addUsedSchema) {
      ...
      n = (0, M8e.normalizeId)(a || n);
      let m = M8e.getSchemaRefs.call(this, e, n);
      return (
        (c = new L8e.SchemaEnv({ schema: e, schemaId: u, meta: r, baseId: n, localRefs: m })),
    ...
    _compileSchemaEnv(e) {
      if ((e.meta ? this._compileMetaSchema(e) : L8e.compileSchema.call(this, e), !e.validate))
    ...
    _compileMetaSchema(e) {
      ...
      try {
        L8e.compileSchema.call(this, e);
      } finally {
        this.opts = r;
      }
    }
  };
  F8e.ValidationError = lhs.default;
  F8e.MissingRefError = kgn.default;
  pg.default = F8e;
  function Ign(t, e, r, n = "error") {
    for (let o in t) {
      let s = o;
  ...
  function Rgn(t) {
    return ((t = (0, M8e.normalizeId)(t)), this.schemas[t] || this.refs[t]);
  }
  function yhs() {
  ...
  function vhs() {
    let t = { ...this.opts };
    for (let e of phs) delete t[e];
    return t;
  }
  var Chs = { log() {}, warn() {}, error() {} };
  function Shs(t) {
    if (t === !1) return Chs;
  ...
  var whs = /^[a-z_$][a-z0-9_$:-]*$/i;
  function xhs(t, e) {
    let { RULES: r } = this;
    if (
      ((0, zUt.eachItem)(t, (n) => {
        if (r.keywords[n]) throw new Error(`Keyword ${n} is already defined`);
        if (!whs.test(n)) throw new Error(`Keyword ${n} has invalid name`);
      }),
  ...
  function WUt(t, e, r) {
    ...
    let u = {
      keyword: t,
      definition: { ...e, type: (0, _Ye.getJSONTypes)(e.type), schemaType: (0, _Ye.getJSONTypes)(e.schemaType) },
    };
    (e.before ? Ths.call(this, a, u, e.before) : a.rules.push(u),
      (s.all[t] = u),
  ...
  function Dhs(t) {
    let { metaSchema: e } = t;
    e !== void 0 && (t.$data && this.opts.$data && (e = Ngn(e)), (t.validateSchema = this.compile(e, !0)));
  }
  var Ihs = { $ref: "https://raw.githubusercontent.com/ajv-validator/ajv/master/lib/refs/data.json#" };
  function Ngn(t) {
    return { anyOf: [t, Ihs] };
  }
});