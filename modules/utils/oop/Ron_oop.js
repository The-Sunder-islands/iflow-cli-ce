...
var Ron = T((pQe) => {
  ...
  pQe.CompositePropagator = void 0;
  var Ion = (Zt(), bt(cr)),
    hRt = class {
      _propagators;
      _fields;
      ...
      inject(e, r, n) {
        for (let o of this._propagators)
          try {
            ...
            Ion.diag.warn(`Failed to inject with ${o.constructor.name}. Err: ${s.message}`);
          }
      }
      extract(e, r, n) {
        return this._propagators.reduce((o, s) => {
          try {
            ...
            Ion.diag.warn(`Failed to extract with ${s.constructor.name}. Err: ${a.message}`);
          }
          return o;
        }, e);
      }
