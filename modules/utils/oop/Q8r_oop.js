 ...
 * The original variable name (Q8r) is preserved for compatibility.
...
var Q8r = T((Vil, iFi) => {
  var sTe = rFi(),
    nFi = {};
  for (let t of Object.keys(sTe)) nFi[sTe[t]] = t;
  var Qi = {
  ...
  for (let t of Object.keys(Qi)) {
    ...
    let { channels: e, labels: r } = Qi[t];
    (delete Qi[t].channels,
      delete Qi[t].labels,
      Object.defineProperty(Qi[t], "channels", { value: e }),
      Object.defineProperty(Qi[t], "labels", { value: r }));
  }
  Qi.rgb.hsl = function (t) {
    let e = t[0] / 255,
      r = t[1] / 255,
      n = t[2] / 255,
      o = Math.min(e, r, n),
  ...
  Qi.rgb.keyword = function (t) {
    let e = nFi[t];
    if (e) return e;
    let r = 1 / 0,
      n;
    for (let o of Object.keys(sTe)) {
      let s = sTe[o],
        a = ynu(t, s);
      a < r && ((r = a), (n = o));
    }
  ...
  Qi.keyword.rgb = function (t) {
    return sTe[t];
  };
  Qi.rgb.xyz = function (t) {
    let e = t[0] / 255,
      r = t[1] / 255,
      n = t[2] / 255;
  ...
  Qi.rgb.ansi16 = function (t, e = null) {
    let [r, n, o] = t,
      s = e === null ? Qi.rgb.hsv(t)[2] : e;
    if (((s = Math.round(s / 50)), s === 0)) return 30;
    let a = 30 + ((Math.round(o / 255) << 2) | (Math.round(n / 255) << 1) | Math.round(r / 255));
    return (s === 2 && (a += 60), a);
  };
  Qi.hsv.ansi16 = function (t) {
    return Qi.rgb.ansi16(Qi.hsv.rgb(t), t[2]);
  };
  Qi.rgb.ansi256 = function (t) {
    let e = t[0],
      r = t[1],
      n = t[2];
    return e === r && r === n
  ...
  Qi.hcg.hwb = function (t) {
    let e = t[1] / 100,
      r = t[2] / 100,
      n = e + r * (1 - e);
    return [t[0], (n - e) * 100, (1 - n) * 100];
  };
  Qi.hwb.hcg = function (t) {
    let e = t[1] / 100,
      n = 1 - t[2] / 100,
      o = n - e,
      s = 0;
  ...
  Qi.apple.rgb = function (t) {
    return [(t[0] / 65535) * 255, (t[1] / 65535) * 255, (t[2] / 65535) * 255];
  };
  Qi.rgb.apple = function (t) {
    return [(t[0] / 255) * 65535, (t[1] / 255) * 65535, (t[2] / 255) * 65535];
  };
  Qi.gray.rgb = function (t) {
    return [(t[0] / 100) * 255, (t[0] / 100) * 255, (t[0] / 100) * 255];
  };
  Qi.gray.hsl = function (t) {
    return [0, 0, t[0]];
  };
  Qi.gray.hsv = Qi.gray.hsl;
  Qi.gray.hwb = function (t) {
    return [0, 100, t[0]];
  };
  Qi.gray.cmyk = function (t) {
    return [0, 0, 0, t[0]];
  };
  Qi.gray.lab = function (t) {
    return [t[0], 0, 0];
  };
  Qi.gray.hex = function (t) {
    let e = Math.round((t[0] / 100) * 255) & 255,
      n = ((e << 16) + (e << 8) + e).toString(16).toUpperCase();
    return "000000".substring(n.length) + n;
  };
  Qi.rgb.gray = function (t) {
