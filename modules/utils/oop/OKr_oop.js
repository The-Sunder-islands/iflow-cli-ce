...
var OKr = T((vMe) => {
  ...
  vMe.ConsoleSpanExporter = void 0;
  var $St = Ii(),
    jSt = class {
      export(e, r) {
      ...
      _exportInfo(e) {
        return {
          ...
          kind: e.kind,
          timestamp: (0, $St.hrTimeToMicroseconds)(e.startTime),
          duration: (0, $St.hrTimeToMicroseconds)(e.duration),
      ...
      _sendSpans(e, r) {
        ...
        if (r) return r({ code: $St.ExportResultCode.SUCCESS });
      }
    };
  vMe.ConsoleSpanExporter = jSt;
});