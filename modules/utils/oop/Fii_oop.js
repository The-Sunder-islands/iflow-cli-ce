 ...
 * The original variable name (Fii) is preserved for compatibility.
...
var Fii = T((Mii) => {
  ...
  function Olr(t, e) {
    ...
    this.decodeBuf = Lst.from(t.chars, "ucs2");
    for (var o = Lst.alloc(65536, e.defaultCharSingleByte.charCodeAt(0)), n = 0; n < t.chars.length; n++)
      o[t.chars.charCodeAt(n)] = n;
    this.encodeBuf = o;
  }
  Olr.prototype.encoder = Nlr;
  Olr.prototype.decoder = Plr;
  function Nlr(t, e) {
    this.encodeBuf = e.encodeBuf;
  }
  Nlr.prototype.write = function (t) {
    for (var e = Lst.alloc(t.length), r = 0; r < t.length; r++) e[r] = this.encodeBuf[t.charCodeAt(r)];
    return e;
  };
  Nlr.prototype.end = function () {};
  function Plr(t, e) {
    this.decodeBuf = e.decodeBuf;
  }
  Plr.prototype.write = function (t) {
    for (var e = this.decodeBuf, r = Lst.alloc(t.length * 2), n = 0, o = 0, s = 0; s < t.length; s++)
      ((n = t[s] * 2), (o = s * 2), (r[o] = e[n]), (r[o + 1] = e[n + 1]));
    return r.toString("ucs2");
  };
  Plr.prototype.end = function () {};
});
var $ii = T((owc, Uii) => {
  "use strict";
  Uii.exports = {
