 ...
 * The original variable name (Xyn) is preserved for compatibility.
...
var Xyn = T((Ehc, Jyn) => {
  "use strict";
  var aHt = Object.create;
  aHt && ((uHt = aHt(null)), (cHt = aHt(null)), (uHt[" size"] = cHt[" size"] = 0));
  var uHt, cHt;
  Jyn.exports = function (t) {
    var e = C0(),
      r = e.canEvaluate,
      n = e.isIdentifier,
      o,
