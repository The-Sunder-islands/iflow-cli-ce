 ...
 * The original variable name (C0) is preserved for compatibility.
 * DO NOT rename this module's variable - it's referenced by other modules.
 */


var C0 = T((exports, module) => {
  "use strict";
  var es5 = $V(),
  ...
  function isError(t) {
    return t !== null && typeof t == "object" && typeof t.message == "string" && typeof t.name == "string";
  }
  ...
  function getNativePromise() {
    if (typeof Promise == "function")
      try {
        ...
        if ({}.toString.call(t) === "[object Promise]") return Promise;
      } catch {}
  }
  function domainBind(t, e) {
    return t.bind(e);
  }
  var ret = {
    isClass,
